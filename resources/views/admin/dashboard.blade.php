...
<div style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    ...
    <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
        ...
        <a href="{{ route('batches.index') }}" class="btn btn-primary">Manage Batches</a>
        <a href="#" class="btn btn-primary">View Warehouse Map</a>
        <a href="#" class="btn btn-primary">Bulk Inbound</a>
        <a href="#" class="btn btn-primary">Bulk Outbound</a>
        <a href="#" class="btn btn-primary">Manage Users</a>
    </div>
</div>

<div style="margin-top: 2rem; background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
